    ...
    data() {
      return {
        ...
        exclusionList: {
          ...
          generalInformation: [
            'Дата проведения интервью','Код клиента','Дата постановки на учет','Номер договора','Дата рождения',
            'Серия,номер','Выдан','Дата выдачи','Населенный пункт','Улица','Дом','Номер квартиры','Почтовый индекс',
