    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_children', models.IntegerField(blank=True, null=True, verbose_name='Количество детей')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('withWhomLiving', models.IntegerField(blank=True, choices=[(1, 'одна'), (2, 'с детьми'), (3, 'со своими родителями'), (4, 'с родителями мужа/партнёра'), (5, 'с родственниками'), (6, 'с мужем'), (7, 'с партнёром'), (8, 'с друзьями')], null=True, verbose_name='С кем проживает')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.IntegerField(blank=True, choices=[(1, 'полное среднее (11 классов)'), (2, 'общее среднее (9 классов)'), (3, 'неоконченное общее среднее'), (4, 'начальная школа')], null=True, verbose_name='Образование')),
                ('professionalEducation', models.IntegerField(blank=True, choices=[(1, 'высшее'), (2, 'неоконченное высшее'), (3, 'среднее специальное'), (4, 'начальное профессиональное'), (5, 'отсутствует'), (6, 'обучается')], null=True, verbose_name='Профессиональное образование')),
                ('specialSocialStatus', models.IntegerField(blank=True, choices=[(1, 'инвалидность'), (2, 'многодетная семья'), (3, 'одинокая мать'), (4, 'лицо из числа детей сирот и детей, оставшихся без попечения родителей')], null=True, verbose_name='Особый социальный статус')),
                ('disabilityGroup', models.IntegerField(blank=True, choices=[(1, 'I группа'), (2, 'II группа'), (3, 'III группа')], null=True, verbose_name='Группа инвалидности')),
                ...
                ('durationOfUse', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='Длительность употрбления (в годах)')),
                ...
                ('alcoholUse', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Употрбление алкоголя')),
                ...
                ('husband', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='social_center_app.FamilyMembersInformation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimatedTimeOfInfection', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='Предположительное время инфицирования (в годах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.IntegerField(blank=True, choices=[(1, 'в семье'), (2, 'больница'), (3, 'дом ребенка')], null=True, verbose_name='Место нахождения ребенка')),
                ...
                ('center_prevention', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Учет в лечебно-профилактическом учреждении района')),
                ('hiv_prevention', models.IntegerField(blank=True, choices=[(1, 'во время родов'), (2, 'после родов'), (3, 'не знает')], null=True, verbose_name='Получал ли профилактику ВИЧ')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='social_center_app.Client')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accountingInNarcologicalClinic', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Учёт в наркологическом диспансере')),
                ('criminalRecord', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Наличие судимости')),
                ('accountingInODN_RUVD', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет'), (3, 'не знаю')], null=True, verbose_name='Учёт в ОДН РУВД')),
