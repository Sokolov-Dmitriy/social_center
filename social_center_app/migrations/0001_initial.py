# Generated by Django 3.1.2 on 2020-10-14 20:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dateOfInterview', models.DateField(blank=True, null=True, verbose_name='Дата проведения интервью')),
                ('code', models.TextField(blank=True, null=True, verbose_name='Код клиента')),
                ('formOfReferral', models.IntegerField(blank=True, choices=[(1, 'самообращение'), (2, 'КДН и ЗП'), (3, 'органы опеки и попечительства'), (4, 'образовательные учреждения'), (5, 'дом ребёнка'), (6, 'родильный дом'), (7, 'женская консультация'), (8, 'детская поликлиника'), (9, 'центр СПИД'), (10, 'отдел полиции'), (11, 'УФСИН'), (12, 'перевод'), (13, 'СО НКО')], null=True, verbose_name='Форма обращения')),
                ('dateOfCertified', models.DateField(blank=True, null=True, verbose_name='Дата постановки на учет')),
                ...
                ('dod', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('age', models.IntegerField(blank=True, null=True, verbose_name='Возраст')),
                ('passSeries', models.IntegerField(blank=True, null=True, verbose_name='Серия паспорта')),
                ('passNumber', models.IntegerField(blank=True, null=True, verbose_name='Номер паспорта')),
                ('passFromWhomIssue', models.TextField(blank=True, null=True, verbose_name='Выдан')),
                ('passDateIssue', models.DateField(blank=True, null=True, verbose_name='Дата выдачи')),
                ('addressCity', models.TextField(blank=True, null=True, verbose_name='Населенный пункт')),
                ('addressStreet', models.TextField(blank=True, null=True, verbose_name='Улица')),
                ('addressHouseNum', models.TextField(blank=True, null=True, verbose_name='Дом')),
                ('addressApNum', models.TextField(blank=True, null=True, verbose_name='Номер квартиры')),
                ('addressIndex', models.IntegerField(blank=True, null=True, verbose_name='Почтовый индекс')),
                ('municipalDistrict', models.IntegerField(blank=True, choices=[(1, 'Юго-Запад'), (2, 'Южно-Приморский'), (3, 'Сосновая Поляна'), (4, 'Урицк'), (5, 'Константиновское'), (6, 'Горелово'), (7, 'г.Красное Сел')], null=True, verbose_name='Муниципальный округ')),
                ('phoneNumber', models.TextField(blank=True, max_length=15, null=True, verbose_name='Номер телефона')),
                ('dependence', models.IntegerField(blank=True, choices=[(1, 'алкогольная'), (2, 'наркотическая'), (3, 'созависимость')], null=True, verbose_name='Зависимость')),
                ('stateOfDependence', models.IntegerField(blank=True, choices=[(1, 'активное потребление'), (2, 'ремиссия')], null=True, verbose_name='Состояние зависимости')),
                ('adultsCount', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Кол-во взрослых')),
                ('minorsCount', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Кол-во несовершеннолетних')),
                ('workPlace', models.IntegerField(blank=True, choices=[(1, 'постоянное'), (2, 'временное'), (3, 'эпизодическое'), (4, 'не работает'), (5, 'состоит в центре занятости населения в качестве безработного')], null=True, verbose_name='Место работы')),
                ...
                ('avDoc', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Наличие документов')),
                ('cityzenship', models.IntegerField(blank=True, choices=[(1, 'Россия'), (2, 'страна СНГ')], null=True, verbose_name='Гражданство')),
                ('registration', models.IntegerField(blank=True, choices=[(1, 'постоянная'), (2, 'временная')], null=True, verbose_name='Регистрация')),
                ('placeOfRegistration', models.IntegerField(blank=True, choices=[(1, 'Санкт-Петербург'), (2, 'Ленинградская область'), (3, 'другой регион РФ'), (4, 'страна СНГ')], null=True, verbose_name='Место регистрации')),
                ('education', models.IntegerField(blank=True, choices=[(1, 'высшее'), (2, 'неоконченное высшее'), (3, 'среднее специальное'), (4, 'начальное профессиональное'), (5, 'обучается'), (6, 'полное среднее (11 классов)'), (7, 'общее среднее (9 классов)'), (8, 'неоконченное общее среднее'), (9, 'начальная школа')], null=True, verbose_name='Образование')),
                ('familiesCategory', models.IntegerField(blank=True, choices=[(1, 'полная семья'), (2, 'одинокий родитель'), (3, 'многодетная семья'), (4, 'разведённые'), (5, 'беженцы / переселенцы'), (6, 'несовершеннолетние родители'), (7, 'замещающая семья'), (8, 'семья с инвалидом'), (9, 'другое')], null=True, verbose_name='Категория семей')),
                ('disability', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Инвалидность')),
                ('escort', models.IntegerField(blank=True, choices=[(1, 'интенсивное'), (2, 'поддерживающее'), (3, 'мониторинг')], null=True, verbose_name='Какое сопровождение')),
            ],
            options={
                'verbose_name': 'Клиент',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('maritalStatus', models.IntegerField(blank=True, choices=[(1, 'не замужем'), (2, 'замужем'), (3, 'разведена'), (4, 'вдова')], null=True, verbose_name='Семейное положение')),
                ('withWhomLiving', models.IntegerField(blank=True, choices=[(1, 'со своими родителями'), (2, 'с родителями партнёра'), (5, 'с семьёй'), (6, 'с родственниками')], null=True, verbose_name='С кем проживает')),
                ('regularPartner', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Постоянный партнёр')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.IntegerField(choices=[(0, 'Клиент не может быть относен к типологической группе потребителей ПАВ'), (1, 'Группа 1'), (2, 'Группа 2')], verbose_name='Основная типологическая группа')),
                ('subgroup', models.IntegerField(blank=True, choices=[(1, 'Группа 2.1'), (2, 'Группа 2.2')], null=True, verbose_name='Подгруппа типологической группы 2')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='social_center_app.client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fault', models.IntegerField(blank=True, choices=[(0, 'Нет'), (1, 'Да')], null=True, verbose_name='4.3. Вы испытывали когда-нибудь чувство вины по поводу того, что слишком много или долго употребляли алкоголь (наркотики)?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownership', models.IntegerField(blank=True, choices=[(1, 'договор по найму жилья'), (2, 'собственность клиента')], null=True, verbose_name='Право собственности,владения и пользования')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fullName', models.TextField(blank=True, null=True, verbose_name='ФИО мужа/партнёра')),
                ('address', models.TextField(blank=True, null=True, verbose_name='Адрес')),
                ('telephoneNumber', models.TextField(blank=True, max_length=15, null=True, verbose_name='Телефон')),
                ('dod', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('age', models.IntegerField(blank=True, null=True, verbose_name='Возраст')),
                ('workPlace', models.IntegerField(blank=True, choices=[(1, 'постоянное'), (2, 'временное'), (3, 'эпизодическое'), (4, 'не работает'), (5, 'состоит в центре занятости населения в качестве безработного')], null=True, verbose_name='Место работы')),
                ('aboutWork', models.TextField(blank=True, null=True, verbose_name='Где, кем работает (при наличии работы)')),
                ...
                ('placeOfRegistration', models.IntegerField(blank=True, choices=[(1, 'Санкт-Петербург'), (2, 'Ленинградская область'), (3, 'другой регион РФ'), (4, 'страна СНГ')], null=True, verbose_name='Место регистрации')),
                ('education', models.IntegerField(blank=True, choices=[(1, 'высшее'), (2, 'неоконченное высшее'), (3, 'среднее специальное'), (4, 'начальное профессиональное'), (5, 'обучается'), (6, 'полное среднее (11 классов)'), (7, 'общее среднее (9 классов)'), (8, 'неоконченное общее среднее'), (9, 'начальная школа')], null=True, verbose_name='Образование')),
                ('categoryFamilies', models.IntegerField(blank=True, choices=[(1, 'полная семья'), (2, 'одинокий родитель'), (3, 'многодетная семья'), (4, 'разведённые'), (5, 'беженцы/переселенцы'), (6, 'несовершеннолетние родители'), (7, 'замещающая семья'), (8, 'семья с инвалидом'), (9, 'другое')], null=True, verbose_name='Категория семей')),
                ('disability', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Инвалидность')),
                ...
                ('criminalRecord', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Наличие судимости')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('withdrawal_symptoms', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='В абстинентном синдроме')),
                ('with_mother', models.IntegerField(blank=True, choices=[(1, 'да'), (2, 'нет')], null=True, verbose_name='Ребенок выписан из родильного отделения вместе с матерью')),
